...
import { useAddWarehouse } from "@/services/container.service";
...
export default function Page() {
  ...
  const { mutateAsync } = useAddWarehouse();
  ...
  const onSubmit = async () => {
    try {
      ...
      navigate("/warehouse/" + res.data.data?._id);
      reset();
    } catch (error) {
      toastError(error);
    }
          ...
          <div className="row ">
            <div className="col">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link href={`/warehouse`} className="btn btn-maincolor">
                    View Warehouse
                  </Link>
                </div>
              </div>
